...
-- data to return.
local TEST_SEED = '{ entity = { ["domain"] = { ["test01"] = { id = "test01" } }, ["email"] = { ["test01"] = { id = "test01" } }, ["inbox"] = { ["test01"] = { id = "test01" } }, ["message"] = { ["test01"] = { id = "test01" } }, ["webhook"] = { ["test01"] = { id = "test01" } } } }'
