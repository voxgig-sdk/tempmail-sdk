...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/tempmail-sdk/releases)),
...
```
lua/
├── tempmail_sdk.lua    -- Main SDK module
...
The main module (`tempmail_sdk`) exports the SDK constructor
