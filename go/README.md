...
## Install
```bash
go get github.com/voxgig-sdk/tempmail-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/tempmail-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/tempmail-sdk/go=../tempmail-sdk/go
```
...
```
github.com/voxgig-sdk/tempmail-sdk/go/
...
The root package (`github.com/voxgig-sdk/tempmail-sdk/go`) re-exports everything needed
