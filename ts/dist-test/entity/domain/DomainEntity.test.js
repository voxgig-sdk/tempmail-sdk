...
(0, node_test_1.describe)('DomainEntity', async () => {
    ...
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('TEMPMAIL_TEST_LIVE'));
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set TEMPMAIL_TEST_DOMAIN_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['TEMPMAIL_TEST_DOMAIN_ENTID'];
    const idmapOverridden = null != idmapEnvVal && idmapEnvVal.trim().startsWith('{');
    const env = (0, utility_1.envOverride)({
        'TEMPMAIL_TEST_DOMAIN_ENTID': idmap,
        'TEMPMAIL_TEST_LIVE': 'FALSE',
        'TEMPMAIL_TEST_EXPLAIN': 'FALSE',
        'TEMPMAIL_APIKEY': '',
    });
    idmap = env['TEMPMAIL_TEST_DOMAIN_ENTID'];
