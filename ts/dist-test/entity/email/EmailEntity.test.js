...
function basicSetup(extra) {
    ...
    let idmap = transform(['email01', 'email02', 'email03', 'inbox01', 'inbox02', 'inbox03', 'message01', 'message02', 'message03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['TEMPMAIL_TEST_EMAIL_ENTID'];
    ...
    idmap = env['TEMPMAIL_TEST_EMAIL_ENTID'];
