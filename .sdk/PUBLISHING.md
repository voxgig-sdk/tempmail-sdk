...
|---|---|---|
| `ts/` | @voxgig-sdk/tempmail-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/tempmail-sdk \
      --repository voxgig-sdk/tempmail-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/tempmail-sdk` shows it, and
`npm trust revoke @voxgig-sdk/tempmail-sdk --id=<id>` removes it.
