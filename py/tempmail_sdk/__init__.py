...
class TempmailSDK:
    ...
    def Domain(self, data=None) -> "DomainEntity":
        ...
        from tempmail_sdk.entity.domain_entity import DomainEntity
    ...
    def Inbox(self, data=None) -> "InboxEntity":
        ...
        from tempmail_sdk.entity.inbox_entity import InboxEntity
    ...
    def Message(self, data=None) -> "MessageEntity":
        ...
        from tempmail_sdk.entity.message_entity import MessageEntity
    ...
    def Webhook(self, data=None) -> "WebhookEntity":
        ...
        from tempmail_sdk.entity.webhook_entity import WebhookEntity
