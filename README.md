...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/tempmail` | `npm install @voxgig-sdk/tempmail` |
| Python | `voxgig-sdk-tempmail` | `pip install voxgig-sdk-tempmail` |
| PHP | `voxgig-sdk/tempmail` | `composer require voxgig-sdk/tempmail` |
| Golang | `github.com/voxgig-sdk/tempmail-sdk/go` | `go get github.com/voxgig-sdk/tempmail-sdk/go` |
| Ruby | `voxgig-sdk-tempmail` | `gem install voxgig-sdk-tempmail` |
| Lua | `voxgig-sdk-tempmail` | `luarocks install voxgig-sdk-tempmail` |
